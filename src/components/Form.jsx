                    ...
                    <form className="my-5 space-y-6">
                        ...
                        <div className="flex md:flex-nowrap flex-wrap justify-between gap-5">
                            <label className="w-full">
                                ...
                                <input type="text" placeholder="example: (category)" className="mt-1 block w-full px-3 py-2 bg-white border h-12 border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500 disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none invalid:border-pink-500 invalid:text-pink-600 focus:invalid:border-pink-500 focus:invalid:ring-pink-500" />
                            </label>
                            <div className="dropdown w-full">
                                <span className="block text-md font-medium mb-1 text-black">Occupation*</span>
                                <button className="dropbtn border px-3 py-2 h-12 border-slate-300 rounded-md text-lg shadow-sm flex items-center gap-2 w-full" type="button">Select <Icon icon="mingcute:down-fill" /></button>
                        ...
                        <div className="flex justify-end">
                            <button type="submit" className="btn bg-[#004282] px-5 py-3 text-white rounded-md">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
